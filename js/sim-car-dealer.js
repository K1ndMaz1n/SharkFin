...
Let me get the paperwork started while the numbers are fresh. I don't want you to miss this deal.`,
    ...
    // Beat 1-16: Revealed $400/month budget
    {
      phase: 1, beat: 16,
      speaker: 'jake',
      expression: 'thinking',
      text: `$400 a month... okay, let me work with that.

*calculating*

At 72 months, that's about $28,800. We can definitely make something work.

You know what? For that budget, forget the Touring. Let me show you the Sport - it's the sweet spot.`,
      choices: [
        { id: 'show_sport', text: "Okay, show me the Sport.", next: [1, 4], pressure: 10, note: "Got redirected to Sport" },
        { id: 'lx_only', text: "I just want the LX. What's that monthly?", next: [1, 3], pressure: -5, note: "Stayed on target" }
      ]
    },
    // Beat 1-17: Asked for total on Touring, not monthly
    {
      phase: 1, beat: 17,
      speaker: 'jake',
      expression: 'thinking',
...
But look, if that's too high, we've got options. The Sport is a great middle ground.`,
      choices: [
        { id: 'too_high', text: "Yeah, that's way too high. Show me the LX.", next: [1, 3], pressure: -5, note: "Rejected Touring, back to LX" },
        { id: 'sport_middle', text: "What's the Sport out the door?", next: [1, 19], pressure: 5, note: "Considering middle option" }
      ]
    },
    // Beat 1-18: Test driving the Sport
    {
      phase: 1, beat: 18,
      background: 'driving',
      speaker: 'jake',
...
The LX is fine for some people, but you seem like someone who appreciates the finer things.`,
      choices: [
        { id: 'sold_on_sport', text: "Okay, I'm interested. What's the damage?", next: [1, 19], pressure: 15, car: 'civic_mid', note: "Sold on Sport during test drive" },
        { id: 'back_to_lx_drive', text: "It's nice, but I think the LX is more my speed.", next: [2, 0], pressure: 0, note: "Resisted during test drive" }
      ]
    },
    // Beat 1-19: Sport price reveal
    {
      phase: 1, beat: 19,
      speaker: 'jake',
      expression: 'friendly',
      text: `The Sport... let me check.

*looks at sticker*

MSRP is $27,500. Out the door with everything, you're probably looking at $29,000-ish.

But I can talk to my manager. For you? I think we can get close to $28,000.`,
      choices: [
        { id: 'do_28k', text: "If you can do $28,000 flat, I'm in.", next: [2, 0], pressure: 5, car: 'civic_mid', spent: 28000, note: "Bought Sport at budget max" },
        { id: 'lx_cheaper', text: "That's my whole budget. What's the LX?", next: [1, 3], pressure: -5, note: "Sport too expensive, back to LX" }
      ]
    },
    // Beat 1-20: No trade, outside financing - pushing back hard
    {
      phase: 1, beat: 20,
      speaker: 'jake',
      expression: 'concerned',
...
Best I can do is $24,300. That's rock bottom.`,
      choices: [
        { id: 'take_24300', text: "Deal. $24,300.", next: [2, 0], pressure: 0, spent: 24300, note: "Got good deal" },
        { id: 'push_24k', text: "I said $24k. Can you do it or not?", next: [2, 20], pressure: -10, note: "Pushed harder" }
      ]
    },
    // Beat 1-21: Has a trade-in
    {
      phase: 1, beat: 21,
      speaker: 'jake',
      expression: 'friendly',
      text: `A 2018 Corolla? Nice! Those hold value pretty well.

*pretends to look something up*

I can probably give you... $6,500 for it. That brings your out-of-pocket way down.

So the Civic LX at $24,000 minus $6,500... you're looking at $17,500 plus tax. Easy!`,
      choices: [
        { id: 'trade_low', text: "Wait, KBB says it's worth $8,500.", next: [1, 25], pressure: -5, note: "Called out lowball trade offer" },
        { id: 'accept_trade', text: "Okay, that works. Let's do it.", next: [2, 0], pressure: 10, spent: 24000, note: "Accepted lowball trade value" }
      ]
    },
    // Beat 1-23: Slowed down Jake's rush
    {
      phase: 1, beat: 23,
      speaker: 'jake',
      expression: 'sincere',
...
Take your time. No pressure. But just so you know - this price I quoted? I can't guarantee it tomorrow. My manager's in a good mood today.`,
      choices: [
        { id: 'need_lx', text: "I appreciate it, but I came for the LX. Let's focus on that.", next: [1, 3], pressure: -5, note: "Redirected to original goal" },
        { id: 'okay_touring', text: "Fine, fine. Let's talk numbers on the Touring.", next: [2, 2], pressure: 15, car: 'civic_touring', note: "Caved to time pressure" }
      ]
    },
    // Beat 1-25: Called out lowball trade
    {
      phase: 1, beat: 25,
      speaker: 'jake',
      expression: 'laughing',
...
Look, what if we stretched the loan to 72 months? That brings your monthly way down. Or... we could look at the Sport instead. Best of both worlds.`,
      choices: [
        { id: 'no_stretch', text: "I'm not doing 72 months. Show me the LX.", next: [1, 3], pressure: -10, note: "Rejected long loan, back to LX" },
        { id: 'sport_compromise', text: "What's the Sport cost?", next: [1, 19], pressure: 5, note: "Compromised to Sport" }
      ]
    },
    // Beat 2-10: Went $4k over budget on Touring
    {
      phase: 2, beat: 10,
      speaker: 'jake',
      expression: 'proud',
      text: `That's what I like to hear! You won't regret this.
...
Sound good?`,
      choices: [
        { id: 'sounds_good', text: "Let's do it.", next: [3, 0], pressure: 10, spent: 32000, car: 'civic_touring', note: "Committed to $4k over budget" },
        { id: 'wait_too_high', text: "Wait... that's really high. Let me think.", next: [2, 9], pressure: -5, note: "Having second thoughts" }
      ]
    },
    // Beat 2-11: Called out Accord bait-and-switch
    {
      phase: 2, beat: 11,
      speaker: 'jake',
      expression: 'sincere',
...
Okay. Back to the Civic. The LX at $24,000-ish, right? Let's make that happen.`,
      choices: [
        { id: 'yes_lx', text: "Yes. The LX. That's what I came for.", next: [2, 0], pressure: -15, note: "Successfully resisted misdirection" },
        { id: 'maybe_accord', text: "I mean... if you could get closer to $28k on the Accord...", next: [2, 12], pressure: 20, note: "Still tempted by Accord" }
      ]
    },
    // Beat 2-12: Considering Accord overspend
    {
      phase: 2, beat: 12,
      speaker: 'jake',
      expression: 'thinking',
...
That's as low as I can go. What do you say?`,
      choices: [
        { id: 'take_accord', text: "Alright. Let's do the Accord.", next: [3, 0], pressure: 15, spent: 30000, car: 'accord', note: "Bought Accord $2k over budget" },
        { id: 'too_much', text: "That's still too much. I need the Civic.", next: [2, 0], pressure: -10, note: "Finally resisted Accord" }
      ]
    },
    // Beat 2-13: Caught the 72-month trap
    {
      phase: 2, beat: 13,
      speaker: 'jake',
      expression: 'laughing',
...
But if you want a shorter term, we can do 60 months. Your payment goes up to about $480 though. Still comfortable?`,
      choices: [
        { id: 'sixty_ok', text: "60 months is fine. What's the total price?", next: [2, 5], pressure: -5, note: "Negotiated better terms" },
        { id: 'total_price', text: "Forget monthly. What's the out-the-door price?", next: [2, 5], pressure: -10, note: "Escaped the monthly trap" }
      ]
    },
    // Beat 2-14: Missed the 72-month trap
    {
      phase: 2, beat: 14,
      speaker: 'jake',
      expression: 'friendly',
      text: `Great! So at $400 a month for 72 months, you're golden.

*writing*

Now let's just get you protected with the extended warranty. It's only $35 more a month - barely noticeable.`,
      choices: [
        { id: 'add_warranty_72', text: "Sure, add the warranty.", next: [2, 7], pressure: 15, addon: 'extended_warranty', note: "Added warranty on bad loan" },
        { id: 'no_warranty_72', text: "No warranty. But wait - what's my total?", next: [2, 19], pressure: 0, spent: 28800, note: "Realized total is high" }
      ]
    },
    // Beat 2-17: Thinking about $24,800 offer
    {
      phase: 2, beat: 17,
      speaker: 'jake',
      expression: 'friendly',
      text: `Take your time. I'll be right here.
...
What's holding you back?`,
      choices: [
        { id: 'want_lower', text: "I was hoping to stay under $24,000.", next: [2, 15], pressure: 0, note: "Asked for lower price" },
        { id: 'ok_deal', text: "Alright. $24,800. Let's do it.", next: [3, 0], pressure: 5, spent: 24800, note: "Accepted $24,800" }
      ]
    },
    // Beat 2-18: Added rust and paint protection
    {
      phase: 2, beat: 18,
      speaker: 'jake',
      expression: 'proud',
      text: `Smart move. Your car's gonna look brand new for years.
